...
# You should shake the sprite and not the root node to avoid unexpected behavior
...
# Called every physics frame to update the node's position based on the shake effect
